...
export const formatTime = "DD/MM/YYYY";
export const DEFAULT_IMAGE="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDtXNIrA4Pp4ZKxpT-pPVaCG59QdJWm1GD4Q&usqp=CAU";
export const ACCESS_TOKEN ="access_token";

export const MESSAGE_FORM_ERROR = {
    existing_user_login:'Tên đăng nhập đã tồn tại',
    existing_user_email:'Email đã tồn tại',
    rest_user_invalid_password:'Mât khẩu không hợp lệ',
